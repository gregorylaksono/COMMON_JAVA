 ...
 *
 */
public class ImportAcceptanceView implements Serializable{
	...
	private String next_ca_2lc;
	private String next_ca_name;
	...
	private Date trans_flt_date;
	private String trans_flt_no;
	private String cuc_3lc;
	private Integer istotal;
	private Double vol;
	
	public NewExportAcceptanceView convertToNewExportAcceptanceView()
	{
		NewExportAcceptanceView bean = new NewExportAcceptanceView();
		...
		bean.setMani_rem(getMani_rem());
		bean.setStor_name(getStor_name());
	...
	public String getNext_ca_2lc()
	{
		return next_ca_2lc;
	}

	public void setNext_ca_2lc(String next_ca_2lc)
	{
		this.next_ca_2lc = next_ca_2lc;
	}

	public String getNext_ca_name()
	{
		return next_ca_name;
	}

	public void setNext_ca_name(String next_ca_name)
	{
		this.next_ca_name = next_ca_name;
	}
	...
	public Date getTrans_flt_date() {
		return trans_flt_date;
	}

	public void setTrans_flt_date(Date trans_flt_date) {
		this.trans_flt_date = trans_flt_date;
	}

	public String getTrans_flt_no() {
		return trans_flt_no;
	}

	public void setTrans_flt_no(String trans_flt_no) {
		this.trans_flt_no = trans_flt_no;
	}
    ...
    public boolean isBooked() {
        return "xxkk".equals(bkg_status) ? true : false;
    }

    public boolean isAwbAccepted() {
        return awb_acc_per_airport != null && awb_acc_per_airport == 1 && (awb_discr_id == null || awb_discr_condition_flag.compareTo(1) == 0) ? true  : false;
    }

    public boolean isShipmentApproved() {
        if (shipment_discr_id == null || shipment_discr_condition_flag.compareTo(1) == 0) {
            if (shipment_pcs != null && acc_shipment_item_id != null)
                return true;
        }
        return false;
    }
    ...
    public boolean isDiscrepancy() {
        if (shipment_acc_discr_id != null && shipment_acc_discr_id != 0) return true;
        if (awb_discr_id != null && awb_discr_id != 0) return true;
        return false;
    }
