 ...
 *
 */
public class NewExportAcceptanceView implements Serializable, Cloneable{
    ...
    public boolean isShipmentApproved() {
        if (shipment_discr_id == null || shipment_discr_condition_flag.compareTo(1) == 0) {
            if (shipment_pcs != null && acc_shipment_pkg_id != null)
                return true;
        }
        return false;
    }

    public boolean isImportShipmentApproved() {
        if (shipment_discr_id == null || shipment_discr_condition_flag.compareTo(1) == 0) {
    ...
    public boolean isFlightClosed() {
        return stat_id.equalsIgnoreCase("mmmn") ? true  : false;
    }

    public boolean isLoaded() {
        return (is_loaded != null && is_loaded == 1) ? true : false;
    }
    ...
    @Override
	public NewExportAcceptanceView clone() throws CloneNotSupportedException
	{
		return (NewExportAcceptanceView)super.clone();
	}	
}
