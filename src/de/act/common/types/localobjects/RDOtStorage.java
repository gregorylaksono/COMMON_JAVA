...
public class RDOtStorage implements Serializable, Comparable<RDOtStorage>
{
	 ...
	 */
	public int compareTo(RDOtStorage o)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof RDOtStorage)
		{
			if (this.ot_1lc != null && this.ot_2lc != null && ((RDOtStorage) obj).ot_1lc != null
					&& ((RDOtStorage) obj).ot_2lc != null)
			{
				return ((RDOtStorage) obj).ot_1lc.equals(ot_1lc) && ((RDOtStorage) obj).ot_2lc.equals(ot_2lc);
			}
		}
		return false;
	}
